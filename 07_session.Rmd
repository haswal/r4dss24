...
* [dplyr](https://rstudio.github.io/cheatsheets/data-transformation.pdf) (Listed again because the sheet includes `*_join()` functions)
...
Learning regular expressions (regex) is a bit challenging and therefore having good learning tools is important. The strings chapter in the textbook is a good start, but I find it best to practice regex using interactive online tools. This link is a good resource and will teach you regex basics as well as let you practice interactively (I visit this site occasionally and learn something new every time): [https://regexone.com](https://regexone.com)
