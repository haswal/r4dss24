...
**Recreate a report**: Download the R Markdown document and image above and store them in your R Project folder. Use the downloaded document as a starting point and modify it so that it ends up looking like [this final report](https://melodic-kashata-42b883.netlify.app/){target="_blank"}. Here are some tips:
