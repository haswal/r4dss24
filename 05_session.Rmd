...
Check out this [blog post](https://www.andrewheiss.com/blog/2024/04/04/group_by-summarize-ungroup-animations/) if you would like to see some animations showing how `group_by()`, `summarise()` and `mutate()` work. Note that the examples use the "new" pipe (`|>`), which works exactly the same way as `%>%`. 
